...
<div class="cabinformes index large-9 medium-8 columns content">
    <h3><?= __('Cabinformes') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $cabinforme->numexp]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $cabinforme->numexp]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $cabinforme->numexp], ['confirm' => __('Are you sure you want to delete # {0}?', $cabinforme->numexp)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
